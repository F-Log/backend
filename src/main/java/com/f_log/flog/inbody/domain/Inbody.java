...
//    private Long id;
    ...
    public Inbody(UUID memberUuid, float bodyWeight, float height, float muscleMass, float fatFreeMass,float bodyFatPercentage, float fatMass, float basalMetabolicRate) {

...
public class InbodyRequestDto {
    ...
    public InbodyRequestDto(UUID memberUuid, float bodyWeight, float height, float muscleMass, float fatFreeMass,float bodyFatPercentage, float fatMass, float basalMetabolicRate) {
